...
- (void)formatDate {
    ...
    if (strippedValue.length == 0) {
        ...
        formattedString = [NSString stringWithFormat:@"%@-%@-%@", [strippedValue substringToIndex:4], [strippedValue substringWithRange:NSMakeRange(4, 2)], [strippedValue substringFromIndex:6]] ;
    }
    else {
